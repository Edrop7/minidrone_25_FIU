...
#include "c14_HardwareDeploymentTest.h"
#include <string.h>
...
static emlrtRSInfo c14_emlrtRSI = { 5, /* lineNo */
  ...
  "#HardwareDeploymentTest:1387"       /* pathName */
};
...
static void initialize_c14_HardwareDeploymentTest
  (SFc14_HardwareDeploymentTestInstanceStruct *chartInstance);
static void initialize_params_c14_HardwareDeploymentTest
  (SFc14_HardwareDeploymentTestInstanceStruct *chartInstance);
static void mdl_start_c14_HardwareDeploymentTest
  (SFc14_HardwareDeploymentTestInstanceStruct *chartInstance);
static void mdl_terminate_c14_HardwareDeploymentTest
  (SFc14_HardwareDeploymentTestInstanceStruct *chartInstance);
static void mdl_setup_runtime_resources_c14_HardwareDeploymentTest
  (SFc14_HardwareDeploymentTestInstanceStruct *chartInstance);
static void mdl_cleanup_runtime_resources_c14_HardwareDeploymentTest
  (SFc14_HardwareDeploymentTestInstanceStruct *chartInstance);
static void enable_c14_HardwareDeploymentTest
  (SFc14_HardwareDeploymentTestInstanceStruct *chartInstance);
static void disable_c14_HardwareDeploymentTest
  (SFc14_HardwareDeploymentTestInstanceStruct *chartInstance);
static void sf_gateway_c14_HardwareDeploymentTest
  (SFc14_HardwareDeploymentTestInstanceStruct *chartInstance);
static void ext_mode_exec_c14_HardwareDeploymentTest
  (SFc14_HardwareDeploymentTestInstanceStruct *chartInstance);
static void c14_update_jit_animation_c14_HardwareDeploymentTest
  (SFc14_HardwareDeploymentTestInstanceStruct *chartInstance);
static void c14_do_animation_call_c14_HardwareDeploymentTest
  (SFc14_HardwareDeploymentTestInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c14_HardwareDeploymentTest
  (SFc14_HardwareDeploymentTestInstanceStruct *chartInstance);
static void set_sim_state_c14_HardwareDeploymentTest
  (SFc14_HardwareDeploymentTestInstanceStruct *chartInstance, const mxArray
   *c14_st);
static void c14_emlrt_marshallIn(SFc14_HardwareDeploymentTestInstanceStruct
  *chartInstance, const mxArray *c14_nullptr, const char_T *c14_identifier,
  boolean_T c14_y[6400]);
static void c14_b_emlrt_marshallIn(SFc14_HardwareDeploymentTestInstanceStruct
  *chartInstance, const mxArray *c14_u, const emlrtMsgIdentifier *c14_parentId,
  boolean_T c14_y[6400]);
static void init_dsm_address_info(SFc14_HardwareDeploymentTestInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc14_HardwareDeploymentTestInstanceStruct *
  chartInstance);
  ...
  (SFc14_HardwareDeploymentTestInstanceStruct *chartInstance)
{
  ...
  covrtEmlFcnInitFcn(chartInstance->c14_covrtInstance, 4U, 0U, 0U,
                     "c14_HardwareDeploymentTest", 0, -1, 137);
}
...
const mxArray *sf_c14_HardwareDeploymentTest_get_eml_resolved_functions_info
  (void)
{
...
/* SFunction Glue Code */
void sf_c14_HardwareDeploymentTest_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c14_HardwareDeploymentTest_third_party_uses_info(void)
{
...
mxArray *sf_c14_HardwareDeploymentTest_jit_fallback_info(void)
{
...
mxArray *sf_c14_HardwareDeploymentTest_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c14_HardwareDeploymentTest(void)
{
  ...
  sf_c14_HardwareDeploymentTest_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c14_HardwareDeploymentTest(void
  *chartInstanceVar)
{
  initialize_params_c14_HardwareDeploymentTest
    ((SFc14_HardwareDeploymentTestInstanceStruct*) chartInstanceVar);
  initialize_c14_HardwareDeploymentTest
    ((SFc14_HardwareDeploymentTestInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c14_HardwareDeploymentTest(void *chartInstanceVar)
{
  enable_c14_HardwareDeploymentTest((SFc14_HardwareDeploymentTestInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c14_HardwareDeploymentTest(void *chartInstanceVar)
{
  disable_c14_HardwareDeploymentTest((SFc14_HardwareDeploymentTestInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c14_HardwareDeploymentTest(void *chartInstanceVar)
{
  sf_gateway_c14_HardwareDeploymentTest
    ((SFc14_HardwareDeploymentTestInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c14_HardwareDeploymentTest
  (SimStruct* S)
{
  return get_sim_state_c14_HardwareDeploymentTest
    ((SFc14_HardwareDeploymentTestInstanceStruct *)sf_get_chart_instance_ptr(S));/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c14_HardwareDeploymentTest(SimStruct* S,
  const mxArray *st)
{
  set_sim_state_c14_HardwareDeploymentTest
    ((SFc14_HardwareDeploymentTestInstanceStruct*)sf_get_chart_instance_ptr(S),
     st);
}

static void sf_opaque_cleanup_runtime_resources_c14_HardwareDeploymentTest(void *
  chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc14_HardwareDeploymentTestInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    mdl_cleanup_runtime_resources_c14_HardwareDeploymentTest
      ((SFc14_HardwareDeploymentTestInstanceStruct*) chartInstanceVar);
...
static void sf_opaque_mdl_start_c14_HardwareDeploymentTest(void
  *chartInstanceVar)
{
  mdl_start_c14_HardwareDeploymentTest
    ((SFc14_HardwareDeploymentTestInstanceStruct*) chartInstanceVar);
  if (chartInstanceVar) {
    sf_reset_warnings_ChartRunTimeInfo
      (((SFc14_HardwareDeploymentTestInstanceStruct*)chartInstanceVar)->S);
  }
}

static void sf_opaque_mdl_terminate_c14_HardwareDeploymentTest(void
  *chartInstanceVar)
{
  mdl_terminate_c14_HardwareDeploymentTest
    ((SFc14_HardwareDeploymentTestInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c14_HardwareDeploymentTest(SimStruct *S)
{
...
const char* sf_c14_HardwareDeploymentTest_get_post_codegen_info(void)
{
  int i;
  const char* encStrCodegen [21] = {
    "eNrdWFtv3EQUno1CoKhUrYSUCiHRR16QeqEqEgia7KXdKiFbvEmBFzprH9ujHc+4c9nNovadB/5",
    "A/0F/Dk+In8Ejj5zxejfLZkk8XqkJWHKcY/ubc5nvXLyk0d0neFzD8/k2IVt4fQ/PDTI93inlxs",
    "I5vb9Jvirl3vuEhClVpitiSfyPUEaQgAhsHLNjT6ywWY8qmukaegXN4DvQklvDpPAznokYFIgQF",
    "8ilMl56NcssZ2LYsSJ0mvWzlIVpkErLo11ckEYHgk/+TW9uTQ81tpiC0HQAIpMqaZO0w2lydhSU",
    "GTdTCIfaZt6x0mACmztX9b7lhuUc2scQdoU2FKOgz/E3MNRA0xx7M4TpYIaWWc4ZFdVjnVIdQI7",
    "sMHCYR/j3wBqMXkW9qG/ABDVSMcrbGW86hlfE9jjauY+05t5xNplpwcAmCROJi66yGQj0H3lSIV",
    "ZxU45A0QQOhGcOOu/ax8UGz3lZPQe7jpa1ctBm013RtbCF3vYII6Rr6u2Eokk5137Yvsz3YAS80",
    "N+ihtbATvV7gLVmUV8eUeWywDOTrGAvLJTYphQRq77DoyVUUXC/xeJZAc4yRymIMMxz0+cLncdJ",
    "q43MmphGrb29ivpOY7vCgIppCJVrn6JMAxpc8MpTb8Q0HXCHxiiZwsvKK4CoDSU6tqI1lmqIMfY",
    "tsiexcpngh4YogRYYKApGG9l9RLmtaHOmscI5ehxqrFh+ehHr8qcWOKRhCpHrJ4zDPmi3gK5cn7",
    "GP7KC3I2YmLdChYnnVTLIaImwkLkr9SQ6HYijkWHSUzIJyIjiDVwBYNagS2BZ2sS2pSQeNr2a1g",
    "hd9x6w641lGDacDx41HILCzOF9dJ6QhZlVb4OiGBq2DDdjP2NqFZtrgODVpFzkQFfPozYbfPHqj",
    "lO/Nc6mr+wp3imIbFjgp7QyKYQ/6LIPiRkBxppiK5eH03iYneq9snK13A/9r1MSRNXG9Bdzmivh",
    "8tIC7Xsrhnc9/ekxVNKYK8zbncuLGiz5os9r/qxXiXgVHTuFO9M2uny7gGyv0koXrOvv0cAH3wZ",
    "KezSXcVhm73quXN99s/vr6Qfz7L50brS/X0f+bJ6+vlfLHszlt3slGp4q9e/fxObzYXuLFdtE/n",
    "jyKfxgm4ZPW06P8sPc0/v7+A9ks1rvlae/s/i08DRa6om6qsBuV31xOpnb6LeDW/2LB3q1z1r+y",
    "wCdC/vxmPfyHD5fxq+L17lK8nLz7jGXYNv7B38teNy6qTl2knVXqV+Mt48hbxq3rn29d/q+/f/u",
    "MekCW3r9+if1Yvtbtz5fNrz+IXz/6pJS/nn9DN1PGoxVTfPkYB+141dP/Cb//8ozfbF5ou/iVPw",
    "L+eG9HUD7BsX36WVTe7in3+9P8kQKqV38bXUQfIivmv1X9/upSfjt5zEQkx/qzO3fv312nr/0Nn",
    "uQCUw==",
    ""
  };
...
static void mdlSetWorkWidths_c14_HardwareDeploymentTest(SimStruct *S)
{
  const char* newstr = sf_c14_HardwareDeploymentTest_get_post_codegen_info();
...
static void mdlRTW_c14_HardwareDeploymentTest(SimStruct *S)
{
...
static void mdlSetupRuntimeResources_c14_HardwareDeploymentTest(SimStruct *S)
{
  SFc14_HardwareDeploymentTestInstanceStruct *chartInstance;
  chartInstance = (SFc14_HardwareDeploymentTestInstanceStruct *)utMalloc(sizeof
    (SFc14_HardwareDeploymentTestInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc14_HardwareDeploymentTestInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 1;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c14_HardwareDeploymentTest;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c14_HardwareDeploymentTest;
  chartInstance->chartInfo.mdlStart =
    sf_opaque_mdl_start_c14_HardwareDeploymentTest;
  chartInstance->chartInfo.mdlTerminate =
    sf_opaque_mdl_terminate_c14_HardwareDeploymentTest;
  chartInstance->chartInfo.mdlCleanupRuntimeResources =
    sf_opaque_cleanup_runtime_resources_c14_HardwareDeploymentTest;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c14_HardwareDeploymentTest;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c14_HardwareDeploymentTest;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c14_HardwareDeploymentTest;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c14_HardwareDeploymentTest;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c14_HardwareDeploymentTest;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c14_HardwareDeploymentTest;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c14_HardwareDeploymentTest;
  ...
  mdl_setup_runtime_resources_c14_HardwareDeploymentTest(chartInstance);
}

void c14_HardwareDeploymentTest_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_SETUP_RUNTIME_RESOURCES:
    mdlSetupRuntimeResources_c14_HardwareDeploymentTest(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c14_HardwareDeploymentTest(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c14_HardwareDeploymentTest(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c14_HardwareDeploymentTest_method_dispatcher.\n"
