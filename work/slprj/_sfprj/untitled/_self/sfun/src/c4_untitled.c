...
static void c4_emlrt_marshallIn(SFc4_untitledInstanceStruct *chartInstance,
  const mxArray *c4_nullptr, const char_T *c4_identifier, real_T c4_y[19200]);
static void c4_b_emlrt_marshallIn(SFc4_untitledInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[19200]);
...
const char* sf_c4_untitled_get_post_codegen_info(void)
{
  ...
  const char* encStrCodegen [20] = {
    "eNrdWE9v40QUn1Sly8KyLAhpOSCxRw4glS7Vclgt2+YPRGq2EU5b4IIm9nM86njGnT9Jg8R34AN",
    "w5Ntw4ciZD4AQJ468cZw0uKH1ONK2YMl1n+3fvPd+8/45pNHtETzu49l/SMgWXl/Fc4PMjlcKub",
    "F0zu5vkqeF3H+NkDChynRFLIn/EcoIRiACG8fs3BMrbNqniqa6hl5BU/gStOTWMCn8jGciBgUix",
    "AUyqYyXXs1Sy5k47VgROs36JGFhEiTS8mgfF6TRoeDTf9ObWdNHjS2mIDQdgMgkStpR0uF0dDUL",
    "ykyaCYSn2qbeXGkwgc2cq7pnuWEZh/Y5hF2hDUUW9DX+BoYaaJpz7whhOpijZZpxRkV1rhOqA8g",
    "wOgwcZRH+PbQG2auoF/UNmaBGKkZ5O+VNF+EVsX2OdvYwrLk3zyY1LRja0YiJkWNX2RQE+o9xUo",
    "GruCnHoOgIDoVnDjrv2uf5Bi/isnoOdl1Y1spBm852RdfC5nrbY2RI19TbCUWTcq79sAOZHcAYe",
    "K6/RQ2tgZ3p9wBrzaKBPKbKZYFnJlnBziwU2KYUEau+w+MSKi+4L7B4VoCz1IUUREjzwvTFQtfF",
    "pNVGpk1Mo9bBQUV9l7FdYUDFNITKtU9RpgENzuPKU2/ENB1yh0aWTO5l5RVA1IYSHVvRmkh1ihz",
    "7FtkLrlwm+KEhGkELDOQFo43RfUy5rWhzqrHCufA40lix/PQi1uVPLXBIwwQi108Yhx5ot4CuXJ",
    "+xj+yht2Nmpi3QoWJZ1UyyGiJsJI6lwTSDI3Eq5ER0lEyDYiK4Iq4AsGpQJbAt7GNbUtMOGl/Na",
    "gVnAxdZdcazlBpOhy42PgeBncX56johDTGr2gJHNzRoHWzAvsPWLjTTBsepaTvPgSifR99t+M2j",
    "bxXy40UudfVA4U5RbMMCJ6W9YT7swYClkN8IKM4UM7E4nN5tcqH37sbVejfwv0ZNHFkT93wJt7m",
    "Cn9eXcA8KOfzkWyuwuDiOV+m/V4HnKjhyCXfB7/z6wRK+sUIvWbqusy/LPL1R0rNZwm0VXB39+I",
    "P+/sPffn/75z/vJD+9+fU6+n/xjOP7hfzefC5bdK7xpeLu3v3imjh4WIoDJ+u94ycv4p3J/lcnE",
    "/GkN92G3bPubitf75GnvfP7j/A0WNjyOqnCblR8YzmZ2tns79b/dMnerWvWv7sUT4T88dl6+Hee",
    "l/Gr+LpT4svJ+ycsxTbxj/i97XXipurSTdpZpX41XjKOvGTcuv751uX/+vvbV9QDUnr/wS32o3y",
    "t259vm1+/Er9+9H4hP1t8MzcTxqMVU3vxGAfreNXT/0l8/+XJ33xeaDv+ih/9vnm8Jyif4pg++w",
    "wqbveV+71p8UgB1au/hW6iD1Wdk++V8tvJEyYiOdEffbyzu7NOX/sbPcL9nA==",
    ""
  };
