...
static void initialize_params_c11_untitled(SFc11_untitledInstanceStruct
  *chartInstance);
static void mdl_start_c11_untitled(SFc11_untitledInstanceStruct *chartInstance);
static void mdl_terminate_c11_untitled(SFc11_untitledInstanceStruct
  *chartInstance);
static void mdl_setup_runtime_resources_c11_untitled
  (SFc11_untitledInstanceStruct *chartInstance);
static void mdl_cleanup_runtime_resources_c11_untitled
  (SFc11_untitledInstanceStruct *chartInstance);
...
static void sf_gateway_c11_untitled(SFc11_untitledInstanceStruct *chartInstance);
static void ext_mode_exec_c11_untitled(SFc11_untitledInstanceStruct
  *chartInstance);
static void c11_update_jit_animation_c11_untitled(SFc11_untitledInstanceStruct
  *chartInstance);
static void c11_do_animation_call_c11_untitled(SFc11_untitledInstanceStruct
  *chartInstance);
...
static void c11_emlrt_marshallIn(SFc11_untitledInstanceStruct *chartInstance,
  const mxArray *c11_nullptr, const char_T *c11_identifier, uint8_T c11_y[1600]);
static void c11_b_emlrt_marshallIn(SFc11_untitledInstanceStruct *chartInstance,
  const mxArray *c11_u, const emlrtMsgIdentifier *c11_parentId, uint8_T c11_y
  [1600]);
static int32_T c11__s32_add__(SFc11_untitledInstanceStruct *chartInstance,
...
static int32_T c11__s32_minus__(SFc11_untitledInstanceStruct *chartInstance,
  int32_T c11_b, int32_T c11_c, int32_T c11_EMLOvCount_src_loc, uint32_T
  c11_ssid_src_loc, int32_T c11_offset_src_loc, int32_T c11_length_src_loc);
static void init_dsm_address_info(SFc11_untitledInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc11_untitledInstanceStruct *chartInstance);
...
mxArray *sf_c11_untitled_third_party_uses_info(void)
{
...
mxArray *sf_c11_untitled_jit_fallback_info(void)
{
...
mxArray *sf_c11_untitled_updateBuildInfo_args_info(void)
{
...
{
  sf_gateway_c11_untitled((SFc11_untitledInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c11_untitled(SimStruct* S)
{
  return get_sim_state_c11_untitled((SFc11_untitledInstanceStruct *)
...
static void sf_opaque_cleanup_runtime_resources_c11_untitled(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    ...
    mdl_cleanup_runtime_resources_c11_untitled((SFc11_untitledInstanceStruct*)
      chartInstanceVar);
...
static void sf_opaque_mdl_start_c11_untitled(void *chartInstanceVar)
{
  mdl_start_c11_untitled((SFc11_untitledInstanceStruct*) chartInstanceVar);
  if (chartInstanceVar) {
    sf_reset_warnings_ChartRunTimeInfo(((SFc11_untitledInstanceStruct*)
      chartInstanceVar)->S);
  }
}

static void sf_opaque_mdl_terminate_c11_untitled(void *chartInstanceVar)
{
  mdl_terminate_c11_untitled((SFc11_untitledInstanceStruct*) chartInstanceVar);
}
...
const char* sf_c11_untitled_get_post_codegen_info(void)
{
  ...
  const char* encStrCodegen [21] = {
    "eNrdWd1uG0UUHlshpKhUQUKiF5GoEKDeIJFGlXqBSlJ73VrKj8s6TdUbNN499k4yO7udHzvmCeA",
    "9uOMJKsEFb8FTIMQVl5xZrx3jGHtnDYphpc16dvebc+ab75w5OyGV5hHB4w6e3+4QsonXLTyrZH",
    "S8lbcrU+fo/gb5Im+33iEkiKjUTdFNiPsRJCH0QPim22WXjlhh4haVNFYl7Aoaw1egEm40S4Sb8",
    "0x0QYIIsIM0kdrJrmKx4UxcNIwIrGV1FrEg8qPE8PAJdkjDE8GHf2c3NbqFFutMQqAbAKGOZGJ6",
    "UYPT3mIWpB7UIggulImduVKgfZPaoaojwzVLOXiXEDSF0hRZUEvG62uqoaYvnRXClD9GJ3HKGRX",
    "FuY6o8iFFdWg4TUP8e2I0slfQLtrrMEF1IhnlXsxrVuEFsS2Ofh6hrLkzzzrWdeiYXo+JnmVXmh",
    "gEjh91UoCrbi3pg6Q9OBGOMWhH511mEzzRZfEYbFpZlopBE49mRZXCZna9PjKkStptBKJGOVdu2",
    "HaSHkIfeGa/TjUtgR3ZdwArxcJ28oJKGwWOkWQEe20gx9YSEbLiM9yfQWUJ9xiTZwE4i62kIESa",
    "J65POlqmSaN0EtcwjOqHhwXtXcc2hQbZpQEUzn2SMgXocKYrR7shU7TDLRpZ0tkoC/cAojSUqK4",
    "R9UEiL5Bj1yR7xZWNBDc0hD2og4YsYXio7heUm4I+xwoznJXHqcKM5WYXsTZ+SoEDGkQQ2vWEcT",
    "gCZTtQhfMzriMHONo+08M6qECytGgkGQUhLiSWpfYwhVNxIZKBaMgk9vOKYIGuADBrUClwWXiCy",
    "5IcNtD5Yl5LeN22yipTnsVUc9qx2ngKAlcWO1a7EtIAo8oTWLqhQ6tgffYNLu1CMaWxnBp6WQyE",
    "WT16t+JWj76Xt/cmsdRUbYkzRXEZFlgpHXSyYg/aLIbshk+xphg188Pa/Zxc2b1VXWy3ir8qJXF",
    "kRdz+FG5jDj+3p3DbeTvY3f3aCMwuluQ59m8X4LkIjlzDXfE7vt6fwlfm2CVT11XmZZqnd2fsbM",
    "zgNnOuvtsXP8HjX3/W3//45vdP3vywiv2tt910fCdv74zrssnK1b+W3O27z5bo4IMZHdi28vjz+",
    "Pzg5V76sNeqnffPB89ePfefZv293Fzs79aMv+P2PTw1JrYsT8qgGebfWLZNzaj2t/0/mvJ3cwkf",
    "t6b0RMhvX66G/3h/dh43luC38Zc3o9ub8/+jUv4fr43/dwv5X/2L/1Vy7K2L/++X8/9sXfz/tJR",
    "+/LXRz04p/v210c+9cv6vjX7ul9LP2Yx+1r2+uql67ib9LFL3VUritv7FOvOfxK06Ptd69r/+/q",
    "I8QGbe317jcZAF+cnlu2bdxvULcfvu+DBvP57sNdYixsM5ux3540Og3XlP/yf6/sORv/F3lv1eU",
    "Pk/S17tHQjKh4qNtmrGt1vS7tNPHkmgav4e0k2sQ6vsLwyYCJOB+mz3wcMHq6xrfwI/XBYJ",
    ""
  };
...
{
  const char* newstr = sf_c11_untitled_get_post_codegen_info();
...
static void mdlSetupRuntimeResources_c11_untitled(SimStruct *S)
{
  SFc11_untitledInstanceStruct *chartInstance;
  chartInstance = (SFc11_untitledInstanceStruct *)utMalloc(sizeof
  ...
  chartInstance->chartInfo.mdlStart = sf_opaque_mdl_start_c11_untitled;
  chartInstance->chartInfo.mdlTerminate = sf_opaque_mdl_terminate_c11_untitled;
  chartInstance->chartInfo.mdlCleanupRuntimeResources =
    sf_opaque_cleanup_runtime_resources_c11_untitled;
  ...
  mdl_setup_runtime_resources_c11_untitled(chartInstance);
}
...
void c11_untitled_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_SETUP_RUNTIME_RESOURCES:
    mdlSetupRuntimeResources_c11_untitled(S);
    break;
